...
def main():
    ...
    plt.show()
        # Replace problematic characters in the title with underscores
    filename = args.title.replace(' ', '_').replace('&', 'and') + '.png'
    full_path = '/home/jr151/code/LongLM/evaluation/ppl_benchmark/outputs' + filename
